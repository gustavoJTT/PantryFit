...
- Spring Boot Documentation. Available at: https://spring.io/projects/spring-boot
- Java Documentation. Available at: https://docs.oracle.com/en/java/
...
- Support material in Software Engineering and system architecture.
...
- English glossary: [GLOSSARY.md](GLOSSARY.md)
- Portuguese glossary: [docs/pt-BR/GLOSSARIO.md](docs/pt-BR/GLOSSARIO.md)

---

## Summary

PantryFit is a software solution focused on the integrated management of food, inventory, and nutrition. The project seeks to combine domestic organization practices with meal analysis, promoting better control of what exists at home and what is consumed throughout the day. The structure, requirements, and overview of the system were organized according to the required documentation model for architecture and requirements.
